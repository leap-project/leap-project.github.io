var store = [{
        ...
        "tags": [],
        "url": "http://localhost:4000/projects/explaining-dp/",
        "teaser": null
      },{
        "title": "Federated machine learning across RedCap databases",
        "excerpt":"REDCap is a popular database tool for research and survey applications with over 1.3 millions users [1]. It is primarily used in healthcare research to collect and store survey data. One of the goals of the LEAP system is to allow multiple data sources to contribute to data analysis in...","categories": [],
        "tags": [],
        "url": "http://localhost:4000/projects/federated-ml-rcap/",
        "teaser": null
      },{
        "title": "Preserving privacy with data synthesis",
        "excerpt":"Legitimate privacy concerns often limit access to large datasets, either by requiring a very lengthy approval process, or by allowing access to only a small number of dedicated servers (e.g., within a hospital). However, to unleash the full power of various machine learning techniques, we need to find ways to...","categories": [],
        "tags": [],
        "url": "http://localhost:4000/projects/synthesizing-data/",
        "teaser": null
      },{
        "title": "Aline Talhouk",
        "excerpt":"Professor in the Faculty of Medicine at UBC I am assistant professor of Obstetrics and Gynecology in the Faculty of Medicine at the University of British Columbia. I am also a principal investigator at OVCARE, BC gynecological cancer research team, where I direct a data science and informatics laboratory. My...","categories": [],
        "tags": [],
        "url": "http://localhost:4000/team/aline-talhouk/",
        "teaser": "http://localhost:4000/assets/images/team/aline.jpg"
      },{
